    ...
    <div className="bg-[var(--foreground)] border border-gray-200 rounded-lg p-5 flex-grow h-fit space-y-5">
      <div className="flex justify-between items-center">
        ...
        <span className="space-x-4">
          ...
          {/* <Popover>
            <PopoverTrigger className="text-red-600 text-[14px] font-semibold p-0 border-none">Delete</PopoverTrigger>
            <PopoverContent>Are you sure </PopoverContent>
          </Popover> */}
      ...
      <div className="flex justify-between">
        ...
        <span className="flex flex-col">
          <h3 className="font-semibold text-[14px] text-gray-400">
            Salary Type:
          </h3>
          <p className="font-semibold text-[18px] capitalize">
            {jobData?.salaryType}
